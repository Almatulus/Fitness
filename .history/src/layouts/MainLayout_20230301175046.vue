           ...
           <v-btn class="text-none" stacked>
              ...
              <v-navigation-drawer expand-on-hover rail class="vnav" >
                  ...
                  <router-link to="/clients">
                     <v-list-item-title  class="textt" prepend-icon="mdi-account" value="clients">Клиенты</v-list-item-title>
                  </router-link>

                  <router-link to="/trainers">
                          <v-list-item-title class="textt" prepend-icon="mdi-dumbbell"  value="trainers">Тренеры</v-list-item-title>
                  </router-link>
