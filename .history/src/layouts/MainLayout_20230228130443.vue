           ...
           <v-spacer></v-spacer>
              ...
              <v-list nav dense>
                  ...
                  <router-link to="/abonements">
                     <v-list-item prepend-icon="minus-box-multiple" title="Абонементы" value="abonements"></v-list-item>
                  </router-link>

                  <router-link to="/groups">
                     <v-list-item prepend-icon="mdi-account-multiple" title="Отчеты" value="reports"></v-list-item>
                  </router-link>
