  ...
  <div class="main">
     <v-card class="mx-auto overflow-hidden card">
        <v-app-bar>
           ...
           <v-spacer></v-spacer>
           <v-avatar>
             <v-img src="first.jpg" ></v-img>
           </v-avatar>
          
           <v-btn class="text-none" stacked>
              <v-badge content="2" color="#6E64E7">
                 <v-icon color="darkgrey">mdi-bell-outline</v-icon>
              </v-badge>
           </v-btn>

        </v-app-bar>

              <v-navigation-drawer permanent class="vnav" >
              
                  <v-list class="vna" density="default"  nav permament>
                 <router-link to="/clients">
                     <v-list-item  class="textt"  prepend-icon="mdi-account" title="Клиенты"   value="clients"></v-list-item>
                  </router-link>
                
                  <router-link to="/trainers">
                          <v-list-item class="textt" prepend-icon="mdi-dumbbell" title="Тренеры" value="trainers"></v-list-item>
                  </router-link>
