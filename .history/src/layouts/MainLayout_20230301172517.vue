     ...
     <v-card class="mx-auto overflow-hidden card">
        <v-app-bar>
           ...
           <v-btn class="text-none" stacked>
              ...
              <v-navigation-drawer expand-on-hover rail class="vnav" >
              
                  <v-list class="vna" density="default" nav >
                  <router-link to="/clients">
                     <v-list-item  class="textt" prepend-icon="mdi-account" title="Клиенты" font-size:1.05rem value="clients"></v-list-item>
                  </router-link>
