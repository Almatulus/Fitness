        ...
        <v-app-bar color="white" prominent:height="58">
           ...
           <v-avatar>
             <v-img src="https://cdn.vuetifyjs.com/images/john.jpg" alt="John" ></v-img>
              ...
              floating
              >
              <v-list  height="90vh" density="compact"
              nav>
                  <!-- <v-list-item-group 
                  v-model="group"
                  ...
                  <router-link to="/clients">
                     <v-list-item class="px-0 align-center justify-center fill-height" prepend-icon="mdi-account" title="Клиенты" value="clients"></v-list-item>
                  </router-link>
